!(function(t, n) {
  ...
  return (function(t) {
      ...
      (e(10).inspectSource = function(t) {
        ...
        (t.exports = function(t, n, e, a) {
          ...
          f && (o(e, "name") || i(e, "name", n)),
            t[n] !== e &&
              (f && (o(e, u) || i(e, u, t[n] ? "" + t[n] : c.join(String(n)))),
              t === r
                ? (t[n] = e)
                : a
                ? t[n]
        ...
        return function(n, a, y) {
          for (
            var v,
              ...
              x = u(b.length),
              S = 0,
              O = e ? h(n, x) : c ? h(n, 0) : void 0;
            x > S;
            S++
          )
            if ((p || S in b) && ((d = m((v = b[S]), S, g)), t))
              if (e) O[S] = d;
              else if (d)
                switch (t) {
                  case 3:
    ...
    function(t, n, e) {
      var r = e(42),
        i = e(33).concat("length", "prototype");
      n.f =
    ...
    function(t, n, e) {
      t.exports =
        ...
        !e(3)(function() {
          return (
            7 !=
            Object.defineProperty(e(39)("div"), "a", {
              get: function() {
                return 7;
              }
            }).a
    ...
    function(t, n, e) {
      ...
      t.exports = function(t, n, e, y, v, d, g) {
        c(e, n, y);
        var b,
          m,
          x,
          ...
          E = !1,
          w = t.prototype,
          P = w[l] || w["@@iterator"] || (v && w[v]),
          j = P || S(v),
          A = v ? (_ ? S("entries") : j) : void 0,
          N = ("Array" == n && w.entries) || P;
        if (
          (N &&
            (x = s(N.call(new t()))) !== Object.prototype &&
            x.next &&
            (f(x, O, !0), r || "function" == typeof x[l] || u(x, l, h)),
          _ &&
            P &&
            "values" !== P.name &&
            ((E = !0),
          ...
          if (
            ...
            for (m in b) m in w || o(w, m, b[m]);
          else i(i.P + i.F * (p || E), n, b);
        return b;
      };
    },
    function(t, n, e) {
    ...
    function(t, n, e) {
      ...
      var r = e(2),
        ...
        J = function(t, n, e) {
          return (
            ...
            i(H, n)
              ? (e.enumerable
                  ? (i(t, F) && t[F][n] && (t[F][n] = !1),
                    (e = _(e, { enumerable: O(0, !1) })))
                  : (i(t, F) || N(t, F, O(1, {})), (t[F][n] = !0)),
                q(t, n, e))
              : N(t, n, e)
          );
        },
        ...
        K = function(t) {
          var n = M.call(this, (t = S(t, !0)));
          return (
            !(this === G && i(H, t) && !i(D, t)) &&
            (!(n || !i(this, t) || !i(H, t) || (i(this, F) && this[F][t])) || n)
          );
        },
        X = function(t, n) {
          if (((t = x(t)), (n = S(n, !0)), t !== G || !i(H, n) || i(D, n))) {
            var e = A(t, n);
            return (
              !e || !i(H, n) || (i(t, F) && t[F][n]) || (e.enumerable = !0), e
            );
          }
        },
        Q = function(t) {
          for (var n, e = k(x(t)), r = [], o = 0; e.length > o; )
            i(H, (n = e[o++])) || n == F || n == c || r.push(n);
          return r;
        },
        $ = function(t) {
          for (
            var n, e = t === G, r = k(e ? D : x(t)), o = [], u = 0;
            r.length > u;

          )
            !i(H, (n = r[u++])) || (e && !i(G, n)) || o.push(H[n]);
          return o;
        };
      V ||
        (a(
          (C = function() {
            ...
            return o && U && q(G, t, { configurable: !0, set: n }), z(t);
          }).prototype,
          "toString",
          function() {
            return this._k;
        ...
        (e(27).f = K),
        (e(34).f = $),
        o && !e(21) && a(G, "propertyIsEnumerable", K, !0),
        (y.f = function(t) {
          return z(h(t));
        })),
      ...
      for (
        ...
        h(Z[tt++]);
      for (var nt = j(h.store), et = 0; nt.length > et; ) v(nt[et++]);
      u(u.S + u.F * !V, "Symbol", {
        for: function(t) {
        ...
        C.prototype[I] || e(8)(C.prototype, I, C.prototype.valueOf),
        l(C, "Symbol"),
        l(Math, "Math", !0),
        l(r.JSON, "JSON", !0);
    },
    ...
    function(t, n, e) {
      ...
      t.exports = function(t) {
        var n = r(t),
          e = i.f;
        if (e)
          for (var u, a = e(t), c = o.f, f = 0; a.length > f; )
    ...
    function(t, n, e) {
      var r = e(0);
      r(r.S + r.F * !e(6), "Object", { defineProperty: e(4).f });
    },
    function(t, n, e) {
      var r = e(0);
      r(r.S, "Number", {
    ...
    function(t, n, e) {
      for (
        ...
        var d,
          ...
          m = u[g],
          x = m && m.prototype;
        if (x && (x[s] || a(x, s, p), x[l] || a(x, l, g), (c[g] = p), b))
          for (d in r) x[d] || o(x, d, r[d], !0);
      }
    },
    function(t, n, e) {
        ...
        "Array",
        {
          from: function(t) {
            ...
            if (
              ...
              for (e = new h((n = c(p.length))); n > g; g++)
                f(e, g, d ? v(p[g], g) : p[g]);
            else
              for (l = b.call(p), e = new h(); !(i = l.next()).done; g++)
                f(e, g, d ? u(l, v, [i.value, g], !0) : i.value);
            return (e.length = g), e;
          }
        }
      );
        ...
        b = function(t) {
          ...
          if ("string" == typeof n && n.length > 2) {
            var e,
              r,
              i,
              o = (n = g ? n.trim() : p(n, 3)).charCodeAt(0);
            if (43 === o || 45 === o) {
          ...
          ("__proto__" in {}
            ? (function(t, n, r) {
                try {
                  (r = e(22)(
                    Function.call,
                    e(37).f(Object.prototype, "__proto__").set,
                    2
                  ))(t, []),
    ...
    function(t, n, e) {
      ...
      t.exports =
        ...
        e(3)(function() {
          ...
          ? function(t, n) {
              for (
                var e = u(t), c = arguments.length, f = 1, s = i.f, l = o.f;
                c > f;
                ...
                for (
                  var p,
                    h = a(arguments[f++]),
                    y = s ? r(h).concat(s(h)) : r(h),
                    v = y.length,
                    d = 0;
                  v > d;

                )
                  l.call(h, (p = y[d++])) && (e[p] = h[p]);
              return e;
            }
          : c;
    },
      ...
      var u = (function() {
        function t(n, e) {
          ...
          !(function(t, n) {
            ...
            (this.lines = this.el.querySelectorAll(
              "[data-".concat(this.dataAttribute, "]")
            )),
          ...
          (e = [
            {
              key: "_roundHalf",
              value: function(t) {
                return Number((Math.round(2 * Number(t)) / 2).toFixed(1));
              }
            },
            {
              key: "_init",
              value: function() {
                ...
                this.lines &&
                  this.player &&
                  ((this.times = Array.from(this.lines).reduce(function(n, e) {
                    var r = t._roundHalf(e.dataset.playhead);
                    return n[r] || (n[r] = e), n;
                  }, {})),
                  this.touchTextToPlay &&
                    this.lines.forEach(function(n) {
                      var e = function() {
                        n.setAttribute("aria-pressed", "true"),
                          t._movePlayhead(n.dataset.playhead);
                      };
                  ...
                  this.player.addEventListener("loadedmetadata", function() {
                    (!t.audioClipEnd || t.audioClipEnd > t.player.duration) &&
                      (t.audioClipEnd = t.player.duration);
                  }),
                  this.player.addEventListener("pause", function() {
                    (t.isPlaying = !1),
                      t.player.dispatchEvent(t._onPlayStateChange());
                  }),
            ...
            },
            {
              ...
              value: function(t) {
                var n = null;
                this.highlighted && (n = this.highlighted),
                  this._removeHighlights(),
                  t.classList.add(this.highlightClass),
                  (this.highlighted = t),
                  n && n.setAttribute("aria-pressed", !1);
              }
            },
            {
              ...
              value: function() {
                var t = this;
                this.lines.forEach(function(n) {
                  n.classList.remove(t.highlightClass);
                });
              }
            },
            {
              ...
              value: function() {
                if (
                  ...
                  return (this.stopAt = null), this.stop();
                var t = this.times[this.current];
                t &&
                  t !== this.highlighted &&
                  ...
                  this.audioClipEnd &&
                    this._roundHalf(this.current) ===
                      this._roundHalf(this.audioClipEnd) &&
                    this.stop();
              }
            },
            {
            ...
            },
            {
              key: "_movePlayhead",
              value: function(t) {
                var n = this._roundHalf(t);
                n &&
                  this.stopAfterCurrent &&
                  (this.stopAt = this._getNextTime(n)),
                  (this.current = n),
                  this.play();
              }
            },
            {
              ...
              value: function(t) {
                var n = this._roundHalf(t),
                  ...
                  r = e.indexOf(n);
                return e[r + 1] || this._roundHalf(this.audioClipEnd);
              }
            },
            {
              key: "play",
            ...
            },
            {
              ...
              value: function(t) {
                var n = Number(t);
                Number.isNaN(n) && this._movePlayhead(n);
              }
            }
          ]) && o(n.prototype, e),
          i && o(n, i),
